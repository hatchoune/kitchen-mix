...
export async function GET(
  ...
  const appareilLabel =
    recette.modele_thermomix?.[0] === "COMPANION"
      ? "Moulinex Companion"
      : recette.modele_thermomix?.[0] === "COOK_EXPERT"
        ? "Magimix Cook Expert"
        : recette.modele_thermomix?.[0] === "COOKEO"
          ? "Cookeo"
          : recette.modele_thermomix?.[0]?.replace(/_/g, " ") ?? "Robot cuiseur";
